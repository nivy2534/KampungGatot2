...
class SampleDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'name' => 'Festival Panen Kampung Ngebruk',
                'price' => 0,
                'description' => 'Festival tahunan yang menampilkan hasil panen terbaik dari kampung. Ada berbagai lomba tradisional, pameran produk lokal, dan pertunjukan seni budaya. Event gratis untuk seluruh keluarga.',
                'type' => 'event',
                'event_start_date' => '2025-08-15',
                'event_end_date' => '2025-08-17',
                'seller_name' => 'Panitia Desa',
