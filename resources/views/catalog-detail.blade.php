    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
          <a href="{{ route('catalog.show', $relatedProduct->slug) }}" class="block">
            ...
            <div class="p-4">
              ...
              <div class="flex items-center justify-between text-xs text-gray-500">
                ...
                <span class="px-2 py-1 {{ $relatedProduct->type === 'event' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800' }} rounded-full">
                  {{ ucfirst($relatedProduct->type) }}
                </span>
              </div>
            </div>
          </a>
