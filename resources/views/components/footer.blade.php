<footer class="bg-[#13294D] py-12 px-6">
  <div class="container mx-auto">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8">
      ...
      <div>
        ...
        <ul class="text-sm space-y-2 text-gray-700">
          <li><a href="{{ route('blog', ['tag' => 'umkm_lokal']) }}" class="hover:text-[#1B3A6D] transition-colors">UMKM Lokal</a></li>
          <li><a href="{{ route('blog', ['tag' => 'kabar_warga']) }}" class="hover:text-[#1B3A6D] transition-colors">Kabar Warga</a></li>
          <li><a href="{{ route('blog', ['tag' => 'potensi_desa']) }}" class="hover:text-[#1B3A6D] transition-colors">Potensi Desa</a></li>
          <li><a href="{{ route('blog', ['tag' => 'sejarah']) }}" class="hover:text-[#1B3A6D] transition-colors">Sejarah</a></li>
        </ul>
      </div>
