...
@section('content')
  ...
  <section class="py-12 px-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
      @include('components.article-card', ['title' => 'Desa Wisata Dlingo', 'image' => '/images/article1.jpg'])
      @include('components.article-card', ['title' => 'River Wonders Singapore', 'image' => '/images/article2.jpg'])
      @include('components.article-card', ['title' => 'Wisata Kece di Bali & Dompu', 'image' => '/images/article3.jpg'])
      @include('components.article-card', ['title' => 'Pantai Keren di Sumba', 'image' => '/images/article4.jpg'])
    </div>
  </section>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
      @for($i = 0; $i < 4; $i++)
        @include('components.testimonial-card', [
          ...
          'message' => 'Sejak menggunakan Edutech, cara belajar saya jadi jauh lebih menyenangkan! Saya juga bisa mengakses kelas.',
