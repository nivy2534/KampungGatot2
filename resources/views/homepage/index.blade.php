...
@section('content')
    ...
    <section class="py-12 px-6 bg-gray-50">
        <div class="container mx-auto">
            <div class="text-center mb-8">
                <h2 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-3">Produk Unggulan UMKM</h2>
                <p class="text-base text-gray-600 max-w-xl mx-auto">
            ...
            <div class="text-center mt-8">
                <a href="/event" class="inline-flex items-center gap-2 bg-[#1B3A6D] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#0f2a4f] transition-colors">
                    Lihat Semua Produk
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                    </svg>
