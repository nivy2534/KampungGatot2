    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold text-gray-900">Galeri</h2>
        ...
        <!-- Table -->
        <div>
            <table id="photoTable" class="w-full table-auto">
        ...
        <div id="emptyState" class="text-center py-12 hidden">
            ...
            <p class="text-gray-500 mb-6">Belum ada foto di sini</p>
...
@push('addon-script')
    <script>
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            Swal.fire({
                title: 'Hapus Konten?',
                text: 'Apakah Anda yakin ingin menghapus gambar ini? Tindakan ini tidak dapat dibatalkan.',
                icon: 'warning',
                ...
                preConfirm: () => {
                    ...
                    return fetch(_url, {
                        ...
                        .then(data => {
                            ...
                            $('#photoTable').DataTable().ajax.reload();
                        })
                        .catch(error => {
