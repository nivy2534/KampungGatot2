...
@section('content')
    <!-- Stats Cards -->
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 sm:gap-6 mb-4 md:mb-6 px-2 md:px-0">
    ...
    <!-- Recent Activity -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-8 mx-2 md:mx-0">
        <div class="px-4 md:px-6 py-3 md:py-4 border-b border-gray-200">
            <h3 class="text-base font-semibold text-gray-900">Aktivitas Terbaru</h3>
        </div>
        <div class="divide-y divide-gray-200">
            <div class="px-4 md:px-6 py-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-0">
                <div class="flex-1 min-w-0">
            ...
            <div class="px-6 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-0">
                <div class="flex-1 min-w-0">
