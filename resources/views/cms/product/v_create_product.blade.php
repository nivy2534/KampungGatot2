        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-6">
                            <label class="flex items-center">
                                <input type="radio" name="type" value="produk" id="type_produk" checked
                    ...
                    <!-- Rentang Tanggal Event (Hidden by default) -->
                    <div id="eventDateFields" class="hidden space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input id="event_start_date" type="date"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#1B3A6D] focus:border-[#1B3A6D] transition-colors" />
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-700">
                                ...
                                <input id="event_end_date" type="date"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#1B3A6D] focus:border-[#1B3A6D] transition-colors" />
                            </div>
                        </div>
                    </div>
...
<script>
  ...
  document.getElementById("submitBarangBtn").addEventListener("click", async function () {
    ...
    try {
        const response = await fetch("{{ url('dashboard/catalogs/save') }}", {
            method: "POST",
            headers: {
